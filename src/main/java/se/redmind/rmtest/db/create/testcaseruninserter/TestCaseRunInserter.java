...
public class TestCaseRunInserter extends DBBridge {
    ...
    private final static String INSERT_TESTCASERUN = "INSERT INTO report (suite_id, class_id, testcase_id, timestamp," +
            " result, message, os_id, browser_id, device_id, time) " + "VALUES ({suite_id},{class_id},{testcase_id}," +
			"'{timestamp}','{result}', '{message}',{os_id},{browser_id},{device_id},{time})";
    ...
    public boolean insertTestCases(Report report, int suiteID, HashMap<String, Integer> classIDs, HashMap<String,
			Integer> testCases, DriverValidation driverValidation) {
        String sql;
        try {
...
//			System.out.println(System.currentTimeMillis() - start);
            ...
            log.error("Could not insert report. suite name: " + report.getSuiteName() + " timestamp: " + report
					.getTimestamp() + " message: " + e.getMessage());
            return false;
        }
