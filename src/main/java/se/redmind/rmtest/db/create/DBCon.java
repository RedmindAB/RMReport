...
public class DBCon {
    ...
    private void create(Connection conn)  {
        ...
        try {
            ...
            stat.executeUpdate("create table if not exists testruns (suite_id integer, class_id integer, testcase_id integer, timestamp, result, message, name, driver, time float, " +
