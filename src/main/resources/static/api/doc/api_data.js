        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "json",
            "description": "<p>returns a sorted list with the test results thats newer than the last change</p> "
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "./src/main/java/se/redmind/rmtest/web/route/api/live/change/LiveSuiteChange.java",
    "groupTitle": "Live"
  },
  {
    "type": "get",
    ...
    "version": "0.0.0",
    "filename": "./src/main/java/se/redmind/rmtest/web/route/api/live/testrunlist/TestRunListWS.java",
    "groupTitle": "Live"
  },
  {
    "type": "get",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "returns",
            "description": "<p>a suite, with current status etc and tests with current results.</p> "
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "./src/main/java/se/redmind/rmtest/web/route/api/live/suite/LiveSuiteDataWS.java",
    "groupTitle": "Live"
  },
  {
    "type": "get",
